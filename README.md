...
## Модуль search_using_regular_expressions

В данном модуле реализованы функции выполняющие определенные действия

1. Фильтрует транзакции по наличию строки в описании с использованием регулярных выражений. transactions: Список
   словарей с данными о транзакциях search_string: Строка для поиска в описании.
2. Подсчитывает количество операций по категориям с использованием Counter. transactions: Список словарей с данными о
   транзакциях; categories: Список категорий для подсчета
